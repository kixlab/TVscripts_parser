...
main(List<String> arguments) async {
  ...
  for (var f in files){
    // Ignore files; auto-generated by Mac Finder, .keep for empty directory
    if (f.path.endsWith('.DS_Store') || f.path.endsWith('.keep')) continue;
    ...
    new Directory('results').create().then((Directory d) {
      new File(d.path + '/' + basename(f.path) +".json").writeAsStringSync(payload);
    });
  }
}
